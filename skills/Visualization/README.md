...
This family contains golden skills for diagrams, architecture maps, process visuals, and whiteboard artifacts.
...
- Use these skills to create verifiable visual artifacts. Verify generated diagrams render and match the requested concept.
...
- [`DiagramMaker`](DiagramMaker/README.md) — create verified SVG/HTML or Excalidraw diagrams from concepts, systems, and flows.
