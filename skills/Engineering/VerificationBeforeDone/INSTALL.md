# Verification Before Done Install and Readiness Guide

## Purpose

Use this file when setting up, verifying, or documenting readiness for the Verification Before Done skill.

## Readiness model

This skill requires no service install. Setup is knowing the project’s available gates: scripts, tests, linters, type checks, health endpoints, browser checks, generated artifacts, or manual inspection targets.
