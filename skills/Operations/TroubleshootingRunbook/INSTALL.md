# Troubleshooting Runbook Install and Readiness Guide

## Purpose

Use this file when setting up, verifying, or documenting readiness for the Troubleshooting Runbook skill.

## Readiness model

No install is required. Setup means having read access to the relevant status command, logs, config, recent changes, and a safe verification signal.
