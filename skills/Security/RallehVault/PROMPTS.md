...
- "Rotate the vault key in a staging store and verify old key fails, new key works."
- "Explain how ralleh-provision should optionally integrate with ralleh-vault."
