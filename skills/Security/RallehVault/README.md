...
Ralleh Keys is the standalone optional Go CLI for local encrypted SecretRef storage on RALLEH-managed hosts.

Current RALLEH source repository: `https://github.com/ralleh-ai/ralleh-keys`
...
Use this skill when installing, verifying, troubleshooting, or operating `ralleh-keys` on a managed host.

Do not use it to dump secrets into chat, logs, docs, evidence, or shell history.

## Files in this skill

- [`INSTALL.md`](INSTALL.md) — install, build, and verify `ralleh-keys`.
