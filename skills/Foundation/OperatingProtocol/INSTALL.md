# Operating Protocol Install and Readiness Guide

## Purpose

Use this file when setting up, verifying, or documenting readiness for the Operating Protocol skill.

## Readiness model

Operating Protocol has no install step. Capability comes from reading the relevant repo guidance and confirming the tools, workspace, permissions, and verification path available for the current task.
