...
This family contains golden skills for controlled interaction with external systems, browser sessions, UI flows, and tool-driven work.
...
- Use these skills for bounded automation only. Do not bypass login, captcha, platform policy, approval gates, or user intent.
...
- [`AgentBrowser`](AgentBrowser/README.md) — safe browser automation for reading, navigating, filling forms, and verifying web UI state.
