# Skill Library Navigation Install and Readiness Guide

## Purpose

Use this file when setting up, verifying, or documenting readiness for the Skill Library Navigation skill.

## Readiness model

No runtime install is required. Setup means confirming the repo checkout, reading the root README or onboarding page, and following canonical `skills/<Family>/<Skill>/` links.
