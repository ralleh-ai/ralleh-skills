# Git and Repo Discipline Install and Readiness Guide

## Purpose

Use this file when setting up, verifying, or documenting readiness for the Git and Repo Discipline skill.

## Readiness model

Git Repo Discipline usually needs no installation beyond a working Git CLI and repository checkout. Setup means verifying that the repo has sane ignore rules, a readable remote, and an available verification command.
